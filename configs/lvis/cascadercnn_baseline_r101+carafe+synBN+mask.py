...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/cascadercnn_baseline_r18+carafe+synBN/epoch_4.pth'
workflow = [('train', 1)]
model = dict(
    type='CascadeRCNN',
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            '/home/ec2-user/data/imagenet_weights/resnet101-5d3b4d8f.pth')),
    neck=dict(
        type='FPN_CARAFE',
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=500,
            mask_thr_binary=0.5)))
work_dir = './work_dirs/cascadercnn_baseline_r18+carafe+synBN'
gpu_ids = range(0, 4)
