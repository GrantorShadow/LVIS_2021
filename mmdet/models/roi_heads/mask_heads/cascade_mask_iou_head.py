...
class CascadeMaskIoUHead(BaseModule):
    """Mask IoU Head.
    ...
    def __init__(self,
        ...
        super(CascadeMaskIoUHead, self).__init__(init_cfg)
    ...
    def get_targets(self, stage, sampling_results, gt_masks, mask_pred, mask_targets,
                    rcnn_train_cfg):
        ...
        # print(rcnn_train_cfg[0])
        mask_pred = (mask_pred > rcnn_train_cfg[stage].mask_thr_binary).float()
